...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="login-content" align="center">
        ...
        <asp:Button ID="btnUsersubmit" class="loginbtn" runat="server" Text="Log In as User"  /><br />
        <asp:Button ID="btnAdminsubmit" class="loginbtn" runat="server" Text="Log In as Admin"  />
    </div>
